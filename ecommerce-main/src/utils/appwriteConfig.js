...
const client = new Client() //conexión
  .setEndpoint("https://cloud.appwrite.io/v1")
  .setProject("6472b862859955d2f424");

const account = new Account(client); //instancias para usar los servicios
const storage = new Storage(client);
const databases = new Databases(client);
const avatars = new Avatars(client);

export const createUser = async (email, password, name) => { //metodos que interactuan con la base de datos
  try {
